...
func TestIntervalTimeToSeconds(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := Core.IntervalTimeToSeconds(tt.args.interval); got != tt.want {
...
func TestValidateIntervalTime(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := Core.ValidateIntervalTime(tt.args.interval); got != tt.want {
...
func TestValidateURL(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := Core.ValidateURL(tt.args.inputURL); got != tt.want {
